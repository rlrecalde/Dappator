...
namespace Dappator.Internal.Test
{
    public class QueryBuilderError
    {
        ...
        public void Insert_Class_With_No_DescriptionAttribute()
        {
            ...
            var queryBuilderMain = new QueryBuilderMainTest();
            ...
            {
                var queryAndValues = queryBuilderMain
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.ClassDescriptionAttribute.Replace("{entityName}", "AnyClassNoDescription")));
        ...
        public void Insert_Property_With_No_DescriptionAttribute()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.PropertyDescriptionAttribute.Replace("{propertyName}", "Name")));
        ...
        public void Insert_Properties_Null()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.PropertiesNotNull));
        ...
        public void Insert_Properties_Not_Anonymous()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.PropertiesAnonymous));
        ...
        public void Insert_Properties_Empty_Anonymous()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.PropertiesAnonymousWithProperties));
        ...
        public void Insert_Properties_Quantity_Do_Not_Match_Values_Quantity()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.ValuesMatchProperties));
        ...
        public void Insert_Properties_With_Class_Property()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.PropertyPrimitive.Replace("{propertyName}", "AnyClassProperty")));
        ...
        public void Insert_Properties_With_Collection_Property()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.PropertyPrimitive.Replace("{propertyName}", "CollectionProperty")));
        ...
        public void Insert_Values_Not_Supplied()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.ValuesSupplied));
        ...
        public void Insert_With_ByteArray_Property_But_Not_ByteArray_Value()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.ValuesType));
        ...
        public void Insert_With_StringArray_Property_Value()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.PropertiesAndValuesByteArray));
        ...
        public void Insert_Bulk_Array_Do_Not_Match_Properties()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.ValuesArrayMatchProperties));
        ...
        [Test]
        public void Insert_Returning_Property_Null()
        {
            #region Arrange
            ...
            {
                var queryAndValues = queryBuilderMain
                    .Insert<AnyClass>(x => new { x.Name, x.Date }, "Name", DateTime.Now)
                    .Returning<AnyClass>(null)
                    .GetQuery();
            });
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.PropertyNotNull));

            #endregion
        }

        [Test]
        public void Insert_Returning_Property_Anonymous()
        {
            #region Arrange
            ...
            var exception = Assert.Throws<ArgumentException>(() =>
            {
                var queryAndValues = queryBuilderMain
                    .Insert<AnyClass>(x => new { x.Name, x.Date }, "Name", DateTime.Now)
                    .Returning<AnyClass>(x => new { x.Name })
                    .GetQuery();
            });
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.PropertyForm.Replace("{propertyName}", "property")));
        ...
        public void Select_Properties_Empty_Anonymous()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.PropertiesEmptyAggregateNotNull));
        ...
        public void Select_Cast_Alias_Null()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.CastNotNullOrEmpty));
        ...
        public void Select_Cast_Property_Not_Found_At_Select()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.CastMatchProperty));
        ...
        public void Update_Where_Value_Not_Supplied()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.OperatorNotIsNullValueSupplied));
        ...
        public void Update_Where_IsNull_Value_Supplied()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.OperatorIsNullValueNotSupplied));
        ...
        public void Update_Where_Not_Between_Value_And_ValueTo_Supplied()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.OperatorNotBetweenValueToNotSupplied));
        ...
        public void Update_Where_Between_ValueTo_Not_Supplied()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.OperatorBetweenValueToSupplied));
        ...
        public void Update_Where_Between_Value_And_ValueTo_Not_Same_Type()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.OperatorBetweenValueValueToSameType));
        ...
        public void Update_Where_In_Value_Not_Array()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.OperatorInValueArray));
        ...
        public void Update_Where_With_ByteArray_Property_But_Not_ByteArray_Value()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.PropertyAndValueArray));
        ...
        public void Update_Where_With_StringArray_Property_Value()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.PropertyAndValueByteArray));
        ...
        public void Select_InnerJoin_PropertyEntity1_Null()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.PropertyForNameNotNull.Replace("{propertyName}", "propertyEntity1")));
        ...
        public void Select_InnerJoin_PropertyEntity1_Anonymous()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.PropertyForm.Replace("{propertyName}", "propertyEntity1")));
        ...
        public void Select_InnerJoin_PropertyEntity2_Null()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.PropertyForNameNotNull.Replace("{propertyName}", "propertyEntity2")));
        ...
        public void Select_InnerJoin_PropertyEntity2_Anonymous()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.PropertyForm.Replace("{propertyName}", "propertyEntity2")));
        ...
        public void Select_GroupBy_Property_Null()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.PropertyForNameNotNull.Replace("{propertyName}", "property")));
        ...
        public void Select_OrderBy_Alias_Null()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.AliasNotNullOrEmpty));
        ...
        public void StoredProcedure_Properties_Empty_Anonymous()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo(Constants.PropertiesNotEmptyButNull));
