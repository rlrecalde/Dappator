...
namespace Dappator.MySql.Internal
{
    internal class QueryBuilderMainMySql : Dappator.Internal.QueryBuilderMain
    {
        public QueryBuilderMainMySql(DbConnection dbConnection)
        {
        ...
        public override Interfaces.IQueryBuilderReturning Insert<T>(Expression<Func<T, dynamic>> properties, params object[] values)
        {
            ...
            base._query += "; SELECT CAST(LAST_INSERT_ID() AS SIGNED)";
        ...
        {
            throw new MethodAccessException("MySql does not support table-valued functions.");
        }
