    ...
    public class QueryBuilder
    {
        ...
        public void Insert_Returning()
        {
            ...
            string queryToValidate = "" +
                "BEGIN" +
                " INSERT INTO AnyClass (Id, Name, Date) VALUES (:p0, :p1, :p2)" +
                " RETURNING CAST(Name AS NUMBER) INTO :generated_id; " +
                "END;";
        ...
        public void TableFunction_Sql()
        {
            ...
            string queryToValidate = "SELECT * FROM TABLE(FnGetUsers ())";
        ...
        public void ScalarFunction_Sql()
        {
            ...
            string queryToValidate = "SELECT FnGetUserId (:p0, :p1) FROM DUAL";
