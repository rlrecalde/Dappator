...
namespace Dappator.PostgreSql.Test
{
    public class Functional : TestBase
    {
        ...
        [Test]
        public void Insert_Bulk_Returning_Another_Column()
        {
            #region Arrange
            ...
            var userValue1 = new Model.UserValue
            {
                UserId = user.Id,
                Value = 1.7,
            };

            var userValue2 = new Model.UserValue
            {
                UserId = user.Id,
                Value = 2.3,
            };
            ...
            var arrayParams = new object[][] {
                new object[] { userValue1.UserId, userValue1.Value },
                new object[] { userValue2.UserId, userValue2.Value },
            };
            ...
            int userId = (int)dataContext
                .Insert<Model.UserValue>(x => new { x.UserId, x.Value }, arrayParams)
                .Returning<Model.UserValue>(x => x.UserId)
                .ExecuteScalar();
        ...
        [Test]
        public async Task Insert_Bulk_Returning_Another_Column_Async()
        {
            #region Arrange
