...
namespace Dappator.Sql.Internal
{
    internal class QueryBuilderMainSql : Dappator.Internal.QueryBuilderMain
    {
        public QueryBuilderMainSql(DbConnection dbConnection)
        {
            base._dbConnection = dbConnection;
            base._dbType = DbType.Sql;
        }
        ...
        public override Interfaces.IQueryBuilderReturning Insert<T>(Expression<Func<T, dynamic>> properties, params object[] values)
        {
            ...
            base._query += "; SELECT CAST(SCOPE_IDENTITY() AS BIGINT)";
        ...
        public override Interfaces.IQueryBuilderSpExecutable StoredProcedure<T>(Expression<Func<T, dynamic>> properties, params object[] values)
        {
            ...
            base._query = $"EXEC {propertiesInfo.EntityName} {string.Join(", ", propertiesInfo.Sentences)}";
