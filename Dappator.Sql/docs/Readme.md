# Dappator - Strongly Typed Query Builder + Data Context with Dapper for MSSQL
...
Finally, when DataContext object is disposed, it closes and disposes the SqlConnection object.
