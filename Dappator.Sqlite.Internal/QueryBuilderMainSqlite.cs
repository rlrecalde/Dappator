...
namespace Dappator.Sqlite.Internal
{
    internal class QueryBuilderMainSqlite : Dappator.Internal.QueryBuilderMain
    {
        public QueryBuilderMainSqlite(DbConnection dbConnection)
        {
            base._dbConnection = dbConnection;
            base._dbType = DbType.Sqlite;
        }
        ...
        public override Interfaces.IQueryBuilderReturning Insert<T>(Expression<Func<T, dynamic>> properties, params object[] values)
        {
            ...
            base._query += "; SELECT CAST(last_insert_rowid() AS BIGINT)";
        ...
        {
            throw new MethodAccessException("Sqlite does not support stored procedures.");
        }
        ...
        {
            throw new MethodAccessException("Sqlite does not support functions.");
        }
