...
namespace Dappator.Sqlite.Test
{
    public class Functional : TestBase
    {
        ...
        public void Setup()
        {
            ...
            base._sqliteConnection = new Microsoft.Data.Sqlite.SqliteConnection(connectionString);
#else
            base._sqliteConnection = new System.Data.SQLite.SQLiteConnection(connectionString);
#endif

            base._sqliteConnection.Open();
            base.CreateTables();
        }
        ...
        {
            base._sqliteConnection.Close();
            base._sqliteConnection.Dispose();
        }
        ...
        public void Insert_Update_Many_Types()
        {
            ...
            var dateTimeOffset = DateTimeOffset.Now.Add(new TimeSpan(1, 1, 1, 1));
            var timeSpan = new TimeSpan(1, 2, 3);
            var dateTimeOffsetToUpdate = DateTimeOffset.Now.Add(new TimeSpan(3, 3, 3, 3));
            var timeSpanToUpdate = new TimeSpan(4, 5, 6);
            ...
            var dataType = new Model.DataType
            {
                ...
                //DateTimeOffset = DateTimeOffset.Now.Add(new TimeSpan(1, 1, 1, 1)),
            ...
            var dataTypeToUpdate = new Model.DataType
            {
                ...
                Float = float.MinValue + 1,
                Double = double.MinValue + 1,
                Decimal = 789.124M + 1,
                Currency = 789.123F + 1,
                Bool = false,
                ...
                //DateTimeOffset = DateTimeOffset.Now.Add(new TimeSpan(3, 3, 3, 3)),
            ...
            int dataTypeId = (int)dataContext
                .Insert<Model.DataType>(x => new { x.Byte, x.Sbyte, x.Short, x.Ushort, x.Int, x.Uint, x.Long, x.Ulong, x.Float, x.Double, x.Decimal, x.Currency, x.Bool, x.String, x.Char, x.Guid, x.DateTime, x.DateTimeOffset, x.TimeSpan, x.Bytes },
                    dataType.Byte, dataType.Sbyte, dataType.Short, dataType.Ushort, dataType.Int, dataType.Uint, dataType.Long, dataType.Ulong, dataType.Float, dataType.Double, dataType.Decimal, dataType.Currency, dataType.Bool, dataType.String, dataType.Char, guid1.ToString(), dataType.DateTime, dateTimeOffset, timeSpan, dataType.Bytes)
                .ExecuteScalar();
            ...
            dataContext
                .Update<Model.DataType>(x => new { x.Byte, x.Sbyte, x.Short, x.Ushort, x.Int, x.Uint, x.Long, x.Ulong, x.Float, x.Double, x.Decimal, x.Currency, x.Bool, x.String, x.Char, x.Guid, x.DateTime, x.DateTimeOffset, x.TimeSpan, x.Bytes },
                    dataTypeToUpdate.Byte, dataTypeToUpdate.Sbyte, dataTypeToUpdate.Short, dataTypeToUpdate.Ushort, dataTypeToUpdate.Int, dataTypeToUpdate.Uint, dataTypeToUpdate.Long, dataTypeToUpdate.Ulong, dataTypeToUpdate.Float, dataTypeToUpdate.Double, dataTypeToUpdate.Decimal, dataTypeToUpdate.Currency, dataTypeToUpdate.Bool, dataTypeToUpdate.String, dataTypeToUpdate.Char, guid2.ToString(), dataTypeToUpdate.DateTime, dateTimeOffsetToUpdate.DateTime, new DateTime(1, 1, 1, timeSpanToUpdate.Hours, timeSpanToUpdate.Minutes, timeSpanToUpdate.Seconds), dataTypeToUpdate.Bytes)
                .Where<Model.DataType>(x => x.Id, Common.Operators.EqualTo, dataTypeId)
                .Execute();
#endif
            ...
            Assert.That(insertedDataType.DateTimeOffset.Year, Is.EqualTo(dateTimeOffset.Year));
            Assert.That(insertedDataType.DateTimeOffset.Month, Is.EqualTo(dateTimeOffset.Month));
            Assert.That(insertedDataType.DateTimeOffset.Day, Is.EqualTo(dateTimeOffset.Day));
            Assert.That(insertedDataType.DateTimeOffset.Hour, Is.EqualTo(dateTimeOffset.Hour));
            Assert.That(insertedDataType.DateTimeOffset.Minute, Is.EqualTo(dateTimeOffset.Minute));
            Assert.That(insertedDataType.DateTimeOffset.Second, Is.EqualTo(dateTimeOffset.Second));
            Assert.That(insertedDataType.TimeSpan.Hour, Is.EqualTo(timeSpan.Hours));
            Assert.That(insertedDataType.TimeSpan.Minute, Is.EqualTo(timeSpan.Minutes));
            Assert.That(insertedDataType.TimeSpan.Second, Is.EqualTo(timeSpan.Seconds));
            ...
            Assert.That(updatedDataType.DateTimeOffset.Year, Is.EqualTo(dateTimeOffsetToUpdate.Year));
            Assert.That(updatedDataType.DateTimeOffset.Month, Is.EqualTo(dateTimeOffsetToUpdate.Month));
            Assert.That(updatedDataType.DateTimeOffset.Day, Is.EqualTo(dateTimeOffsetToUpdate.Day));
            Assert.That(updatedDataType.DateTimeOffset.Hour, Is.EqualTo(dateTimeOffsetToUpdate.Hour));
            Assert.That(updatedDataType.DateTimeOffset.Minute, Is.EqualTo(dateTimeOffsetToUpdate.Minute));
            Assert.That(updatedDataType.DateTimeOffset.Second, Is.EqualTo(dateTimeOffsetToUpdate.Second));
            Assert.That(updatedDataType.TimeSpan.Hour, Is.EqualTo(timeSpanToUpdate.Hours));
            Assert.That(updatedDataType.TimeSpan.Minute, Is.EqualTo(timeSpanToUpdate.Minutes));
            Assert.That(updatedDataType.TimeSpan.Second, Is.EqualTo(timeSpanToUpdate.Seconds));
        ...
        public void Insert_Update_Nullable_Many_Types()
        {
            ...
            Guid guid1 = Guid.NewGuid();
            Guid guid2 = Guid.NewGuid();
            DateTimeOffset? dateTimeOffset = DateTimeOffset.Now.Add(new TimeSpan(1, 1, 1, 1));
            TimeSpan? timeSpan = new TimeSpan(1, 2, 3);
            DateTimeOffset? dateTimeOffsetToUpdate = DateTimeOffset.Now.Add(new TimeSpan(3, 3, 3, 3));
            TimeSpan? timeSpanToUpdate = new TimeSpan(4, 5, 6);
            ...
            int dataTypeId = (int)dataContext
                .Insert<Model.DataTypeNullable>(x => new { x.Byte, x.Sbyte, x.Short, x.Ushort, x.Int, x.Uint, x.Long, x.Ulong, x.Float, x.Double, x.Decimal, x.Currency, x.Bool, x.String, x.Char, x.Guid, x.DateTime, x.DateTimeOffset, x.TimeSpan, x.Bytes },
                    dataType.Byte, dataType.Sbyte, dataType.Short, dataType.Ushort, dataType.Int, dataType.Uint, dataType.Long, dataType.Ulong, dataType.Float, dataType.Double, dataType.Decimal, dataType.Currency, dataType.Bool, dataType.String, dataType.Char, guid1.ToString(), dataType.DateTime, dateTimeOffset?.DateTime, new DateTime(1, 1, 1, timeSpan?.Hours ?? 0, timeSpan?.Minutes ?? 0, timeSpan?.Seconds ?? 0), dataType.Bytes)
                .ExecuteScalar();
#endif
            ...
            dataContext
                .Update<Model.DataTypeNullable>(x => new { x.Byte, x.Sbyte, x.Short, x.Ushort, x.Int, x.Uint, x.Long, x.Ulong, x.Float, x.Double, x.Decimal, x.Currency, x.Bool, x.String, x.Char, x.Guid, x.DateTime, x.DateTimeOffset, x.TimeSpan, x.Bytes },
                    dataTypeToUpdate.Byte, dataTypeToUpdate.Sbyte, dataTypeToUpdate.Short, dataTypeToUpdate.Ushort, dataTypeToUpdate.Int, dataTypeToUpdate.Uint, dataTypeToUpdate.Long, dataTypeToUpdate.Ulong, dataTypeToUpdate.Float, dataTypeToUpdate.Double, dataTypeToUpdate.Decimal, dataTypeToUpdate.Currency, dataTypeToUpdate.Bool, dataTypeToUpdate.String, dataTypeToUpdate.Char, guid2.ToString(), dataTypeToUpdate.DateTime, dateTimeOffsetToUpdate?.DateTime, new DateTime(1, 1, 1, timeSpanToUpdate?.Hours ?? 0, timeSpanToUpdate?.Minutes ?? 0, timeSpanToUpdate?.Seconds ?? 0), dataTypeToUpdate.Bytes)
                .Where<Model.DataTypeNullable>(x => x.Id, Common.Operators.EqualTo, dataTypeId)
                .Execute();
#endif
            ...
            Assert.That(insertedDataType.DateTimeOffset?.Minute, Is.EqualTo(dateTimeOffset?.Minute));
            Assert.That(insertedDataType.DateTimeOffset?.Second, Is.EqualTo(dateTimeOffset?.Second));
            Assert.IsNotNull(insertedDataType.TimeSpan);
            Assert.That(insertedDataType.TimeSpan?.Hour, Is.EqualTo(timeSpan?.Hours));
            Assert.That(insertedDataType.TimeSpan?.Minute, Is.EqualTo(timeSpan?.Minutes));
            Assert.That(insertedDataType.TimeSpan?.Second, Is.EqualTo(timeSpan?.Seconds));
            ...
            Assert.That(updatedDataType.DateTimeOffset?.Minute, Is.EqualTo(dateTimeOffsetToUpdate?.Minute));
            Assert.That(updatedDataType.DateTimeOffset?.Second, Is.EqualTo(dateTimeOffsetToUpdate?.Second));
            Assert.IsNotNull(updatedDataType.TimeSpan);
            Assert.That(updatedDataType.TimeSpan?.Hour, Is.EqualTo(timeSpanToUpdate?.Hours));
            Assert.That(updatedDataType.TimeSpan?.Minute, Is.EqualTo(timeSpanToUpdate?.Minutes));
            Assert.That(updatedDataType.TimeSpan?.Second, Is.EqualTo(timeSpanToUpdate?.Seconds));
        ...
        public void Insert_Update_Null_Many_Types()
        {
            ...
            dataContext
                .Update<Model.DataTypeNullable>(x => new { x.Byte, x.Sbyte, x.Short, x.Ushort, x.Int, x.Uint, x.Long, x.Ulong, x.Float, x.Double, x.Decimal, x.Currency, x.Bool, x.String, x.Char, x.Guid, x.DateTime, x.DateTimeOffset, x.TimeSpan, x.Bytes },
                    dataTypeToUpdate1.Byte, dataTypeToUpdate1.Sbyte, dataTypeToUpdate1.Short, dataTypeToUpdate1.Ushort, dataTypeToUpdate1.Int, dataTypeToUpdate1.Uint, dataTypeToUpdate1.Long, dataTypeToUpdate1.Ulong, dataTypeToUpdate1.Float, dataTypeToUpdate1.Double, dataTypeToUpdate1.Decimal, dataTypeToUpdate1.Currency, dataTypeToUpdate1.Bool, dataTypeToUpdate1.String, dataTypeToUpdate1.Char, guid.ToString(), dataTypeToUpdate1.DateTime, dateTimeOffsetToUpdate, timeSpanToUpdate, dataTypeToUpdate1.Bytes)
                .Where<Model.DataTypeNullable>(x => x.Id, Common.Operators.EqualTo, dataTypeId)
                .Execute();
#else
            ...
            dataContext
                .Update<Model.DataTypeNullable>(x => new { x.Byte, x.Sbyte, x.Short, x.Ushort, x.Int, x.Uint, x.Long, x.Ulong, x.Float, x.Double, x.Decimal, x.Currency, x.Bool, x.String, x.Char, x.Guid, x.DateTime, x.DateTimeOffset, x.TimeSpan, x.Bytes },
                    dataTypeToUpdate1.Byte, dataTypeToUpdate1.Sbyte, dataTypeToUpdate1.Short, dataTypeToUpdate1.Ushort, dataTypeToUpdate1.Int, dataTypeToUpdate1.Uint, dataTypeToUpdate1.Long, dataTypeToUpdate1.Ulong, dataTypeToUpdate1.Float, dataTypeToUpdate1.Double, dataTypeToUpdate1.Decimal, dataTypeToUpdate1.Currency, dataTypeToUpdate1.Bool, dataTypeToUpdate1.String, dataTypeToUpdate1.Char, guid.ToString(), dataTypeToUpdate1.DateTime, dateTimeOffsetToUpdate?.DateTime, new DateTime(1, 1, 1, timeSpanToUpdate?.Hours ?? 0, timeSpanToUpdate?.Minutes ?? 0, timeSpanToUpdate?.Seconds ?? 0), dataTypeToUpdate1.Bytes)
                .Where<Model.DataTypeNullable>(x => x.Id, Common.Operators.EqualTo, dataTypeId)
                .Execute();
#endif
        ...
        public void Insert_Bulk_Many_Types()
        {
            ...
            Guid guid1 = Guid.NewGuid();
            Guid guid2 = Guid.NewGuid();
            var dateTimeOffset1 = DateTimeOffset.Now.Add(new TimeSpan(1, 1, 1, 1));
            var timeSpan1 = new TimeSpan(1, 2, 3);
            var dateTimeOffset2 = DateTimeOffset.Now.Add(new TimeSpan(3, 3, 3, 3));
            var timeSpan2 = new TimeSpan(4, 5, 6);
            ...
            var dataType1 = new Model.DataType
            {
                ...
                Guid = guid1.ToString(),
                DateTime = DateTime.Now,
                DateTimeOffset = dateTimeOffset1.DateTime,
                TimeSpan = new DateTime(1, 1, 1, timeSpan1.Hours, timeSpan1.Minutes, timeSpan1.Seconds),
                Bytes = new byte[] { 4, 5, 6 },
            };
            ...
            var dataType2 = new Model.DataType
            {
                ...
                TimeSpan = new DateTime(1, 1, 1, timeSpan2.Hours, timeSpan2.Minutes, timeSpan2.Seconds),
                Bytes = new byte[] { 7, 8, 9 },
            };
            ...
            var arrayParams = new object[][] {
                new object[] { dataType1.Byte, dataType1.Sbyte, dataType1.Short, dataType1.Ushort, dataType1.Int, dataType1.Uint, dataType1.Long, dataType1.Ulong, dataType1.Float, dataType1.Double, dataType1.Decimal, dataType1.Currency, dataType1.Bool, dataType1.String, dataType1.Char, guid1.ToString(), dataType1.DateTime, dateTimeOffset1, timeSpan1, dataType1.Bytes },
                new object[] { dataType2.Byte, dataType2.Sbyte, dataType2.Short, dataType2.Ushort, dataType2.Int, dataType2.Uint, dataType2.Long, dataType2.Ulong, dataType2.Float, dataType2.Double, dataType2.Decimal, dataType2.Currency, dataType2.Bool, dataType2.String, dataType2.Char, guid2.ToString(), dataType2.DateTime, dateTimeOffset2, timeSpan2, dataType2.Bytes },
            };

#else

            var arrayParams = new object[][] {
                new object[] { dataType1.Byte, dataType1.Sbyte, dataType1.Short, dataType1.Ushort, dataType1.Int, dataType1.Uint, dataType1.Long, dataType1.Ulong, dataType1.Float, dataType1.Double, dataType1.Decimal, dataType1.Currency, dataType1.Bool, dataType1.String, dataType1.Char, guid1.ToString(), dataType1.DateTime, dateTimeOffset1.DateTime, new DateTime(1, 1, 1, timeSpan1.Hours, timeSpan1.Minutes, timeSpan1.Seconds), dataType1.Bytes },
                new object[] { dataType2.Byte, dataType2.Sbyte, dataType2.Short, dataType2.Ushort, dataType2.Int, dataType2.Uint, dataType2.Long, dataType2.Ulong, dataType2.Float, dataType2.Double, dataType2.Decimal, dataType2.Currency, dataType2.Bool, dataType2.String, dataType2.Char, guid2.ToString(), dataType2.DateTime, dateTimeOffset2.DateTime, new DateTime(1, 1, 1, timeSpan2.Hours, timeSpan2.Minutes, timeSpan2.Seconds), dataType2.Bytes },
            };
            ...
            Assert.That(insertedDataType.Ulong, Is.EqualTo(dataType.Ulong));
                ...
                Assert.That(insertedDataType.TimeSpan.Hour, Is.EqualTo(dataType.TimeSpan.Hour));
                Assert.That(insertedDataType.TimeSpan.Minute, Is.EqualTo(dataType.TimeSpan.Minute));
                Assert.That(insertedDataType.TimeSpan.Second, Is.EqualTo(dataType.TimeSpan.Second));
        ...
        public void Insert_Bulk_Nullable_Many_Types()
        {
            ...
            Guid guid1 = Guid.NewGuid();
            Guid guid2 = Guid.NewGuid();
            DateTimeOffset? dateTimeOffset1 = DateTimeOffset.Now.Add(new TimeSpan(1, 1, 1, 1));
            TimeSpan? timeSpan1 = new TimeSpan(1, 2, 3);
            DateTimeOffset? dateTimeOffset2 = DateTimeOffset.Now.Add(new TimeSpan(3, 3, 3, 3));
            TimeSpan? timeSpan2 = new TimeSpan(4, 5, 6);
            ...
            var dataType1 = new Model.DataTypeNullable
            {
                ...
                DateTime = DateTime.Now,
                DateTimeOffset = dateTimeOffset1?.DateTime,
                TimeSpan = new DateTime(1, 1, 1, timeSpan1?.Hours ?? 0, timeSpan1?.Minutes ?? 0, timeSpan1?.Seconds ?? 0),
                Bytes = new byte[] { 4, 5, 6 },
            };
            ...
            var dataType2 = new Model.DataTypeNullable
            {
                ...
                DateTime = DateTime.Now.Add(new TimeSpan(2, 2, 2, 2)),
                DateTimeOffset = dateTimeOffset2?.DateTime,
                TimeSpan = new DateTime(1, 1, 1, timeSpan2?.Hours ?? 0, timeSpan2?.Minutes ?? 0, timeSpan2?.Seconds ?? 0),
                Bytes = new byte[] { 7, 8, 9 },
            };
            ...
            var arrayParams = new object[][] {
                new object[] { dataType1.Byte, dataType1.Sbyte, dataType1.Short, dataType1.Ushort, dataType1.Int, dataType1.Uint, dataType1.Long, dataType1.Ulong, dataType1.Float, dataType1.Double, dataType1.Decimal, dataType1.Currency, dataType1.Bool, dataType1.String, dataType1.Char, guid1.ToString(), dataType1.DateTime, dateTimeOffset1?.DateTime, new DateTime(1, 1, 1, timeSpan1?.Hours ?? 0, timeSpan1?.Minutes ?? 0, timeSpan1?.Seconds ?? 0), dataType1.Bytes },
                new object[] { dataType2.Byte, dataType2.Sbyte, dataType2.Short, dataType2.Ushort, dataType2.Int, dataType2.Uint, dataType2.Long, dataType2.Ulong, dataType2.Float, dataType2.Double, dataType2.Decimal, dataType2.Currency, dataType2.Bool, dataType2.String, dataType2.Char, guid2.ToString(), dataType2.DateTime, dateTimeOffset2?.DateTime, new DateTime(1, 1, 1, timeSpan2?.Hours ?? 0, timeSpan2?.Minutes ?? 0, timeSpan2?.Seconds ?? 0), dataType2.Bytes },
            };
#endif
        ...
        public void Select_With_Cast()
        {
            ...
            Model.DataTypeNullable dataType = dataContext
                ...
                .Cast<Model.DataTypeNullable>(x => x.Float, "INT")
                .Cast<Model.DataTypeNullable>(x => x.Double, "INT")
                .QueryFirstOrDefault<Model.DataTypeNullable>();
            ...
            double expectedDouble = (double)(int)dataTypeToInsert.Double;
        ...
        public void Select_Avg()
        {
            ...
            IEnumerable<Model.UserValueAmount> userValueAmounts = dataContext
                .Select<Model.UserValue>(x => new { x.UserId },
                    aggregate: a =>
                    {
                        a.Avg<Model.UserValue>(x => x.Value, alias: "Amount");
                    })
                .GroupBy<Model.UserValue>(x => x.UserId)
                .Query<Model.UserValueAmount>();
        ...
        public void Insert_Update_In_Transaction()
        {
            ...
            int rowNumber = dataContext
                .Update<Model.User>(x => new { x.Nick, x.Password }, nickToUpdate, passwordToUpdate)
                .Where<Model.User>(x => x.Id, Common.Operators.EqualTo, userId)
                .Execute();
        ...
        public void Insert_Dates()
        {
            ...
            var dataContext = new DataContext(this._sqliteConnection, preventClosing: true);
