...
{
    public class FunctionalContextMySql : See_Firebird_TestBase<Providers.MySqlProvider>
    {
        [SetUp]
        public void Setup()
        {
            base._connectionString = "Server=localhost;Port=3306;Database=Dappator;User ID=root;Password=guest;Allow User Variables=true";
            ...
            var command = new MySqlCommand(createDateAndTime, (MySqlConnection)dbConnection);
            command.ExecuteNonQuery();
            command.Dispose();

            string deleteDateAndTime = "DELETE FROM DateAndTime";

            command = new MySqlCommand(deleteDateAndTime, (MySqlConnection)dbConnection);
            command.ExecuteNonQuery();
            command.Dispose();
        ...
        public void Insert()
        {
            ...
            var userToInsert = new Model.MySql.User
            {
                Nick = "Nick",
                Password = "Password",
            };
            ...
            using var sqlContext = new MySqlContext(base._connectionString);

            int userId = (int)sqlContext
                .Insert<Model.MySql.User>(x => new { x.Nick, x.Password }, userToInsert.Nick, userToInsert.Password)
                .ExecuteScalar();
            ...
            IEnumerable<Model.MySql.User> users = base.GetUsers<Model.MySql.User>();
            Assert.That(users.Count(), Is.EqualTo(1));

            Model.MySql.User insertedUser = users.First();
        ...
        public void Insert_Bulk()
        {
            ...
            var user1ToInsert = new Model.MySql.User
            {
                Nick = "Nick1",
                Password = "Password1",
            };

            var user2ToInsert = new Model.MySql.User
            {
                Nick = "Nick2",
                Password = "Password2",
            };

            var usersToInsert = new List<Model.MySql.User> { user1ToInsert, user2ToInsert };
            ...
            int oneUserId = (int)sqlContext
                .Insert<Model.MySql.User>(x => new { x.Nick, x.Password }, arrayParams)
                .ExecuteScalar();
            ...
            {
                Model.MySql.User user = users.FirstOrDefault(x => x.Nick == userToInsert.Nick && x.Password == userToInsert.Password);
        ...
        public void Update()
        {
            ...
            var user = new Model.MySql.User
            {
                Nick = "Nick",
                Password = "Password",
            };

            base.InsertUser<Model.MySql.User>(user);
            ...
            int rowNumber = sqlContext
                .Update<Model.MySql.User>(x => new { x.Nick, x.Password }, nickToUpdate, passwordToUpdate)
                .Where<Model.MySql.User>(x => x.Id, Common.Operators.EqualTo, user.Id)
                .Execute();
            ...
            Model.MySql.User updatedUser = users.First();
        ...
        public void Select()
        {
            ...
            var user1 = new Model.MySql.User
            {
                Nick = "Nick1",
                Password = "Password1",
            };

            base.InsertUser<Model.MySql.User>(user1);

            var user2 = new Model.MySql.User
            {
                Nick = "Nick2",
                Password = "Password2",
            };

            base.InsertUser<Model.MySql.User>(user2);
            ...
            IEnumerable<Model.MySql.User> users = sqlContext
                .Select<Model.MySql.User>(x => new { x.Id, x.Nick, x.Password })
                .Query<Model.MySql.User>();
        ...
        public async Task Select_Async()
        {
            ...
            IEnumerable<Model.MySql.User> users = await sqlContext
                .Select<Model.MySql.User>(x => new { x.Id, x.Nick, x.Password })
                .QueryAsync<Model.MySql.User>();
        ...
        public void Select_Where()
        {
            ...
            IEnumerable<Model.MySql.User> users = sqlContext
                .Select<Model.MySql.User>(x => new { x.Id, x.Nick, x.Password })
                .Where<Model.MySql.User>(x => x.Id, Common.Operators.EqualTo, user2.Id)
                .Query<Model.MySql.User>();
        ...
        public void Select_Limit()
        {
            ...
            IEnumerable<Model.MySql.User> users = sqlContext
                .Select<Model.MySql.User>(x => new { x.Id, x.Nick, x.Password })
                .OrderBy<Model.MySql.User>(x => x.Id, Common.Orders.Ascending)
                .LimitOffset(1)
                .Query<Model.MySql.User>();
        ...
        public void Select_Limit_FirstOrDefault()
        {
            ...
            Model.MySql.User user = sqlContext
                .Select<Model.MySql.User>(x => new { x.Id, x.Nick, x.Password })
                .OrderBy<Model.MySql.User>(x => x.Id, Common.Orders.Ascending)
                .LimitOffset(1)
                .QueryFirstOrDefault<Model.MySql.User>();
        ...
        public async Task Select_Limit_FirstOrDefault_Async()
        {
            ...
            Model.MySql.User user = await sqlContext
                .Select<Model.MySql.User>(x => new { x.Id, x.Nick, x.Password })
                .OrderBy<Model.MySql.User>(x => x.Id, Common.Orders.Ascending)
                .LimitOffset(1)
                .QueryFirstOrDefaultAsync<Model.MySql.User>();
        ...
        public void Select_Count()
        {
            ...
            var user1Value1 = new Model.MySql.UserValue
            {
                UserId = user1.Id,
                Value = 1.7,
            };

            base.InsertUserValue<Model.MySql.UserValue>(user1Value1);

            var user1Value2 = new Model.MySql.UserValue
            {
                UserId = user1.Id,
                Value = 2.3,
            };

            base.InsertUserValue<Model.MySql.UserValue>(user1Value2);

            var user1Value3 = new Model.MySql.UserValue
            {
                UserId = user1.Id,
                Value = 2.9,
            };

            base.InsertUserValue<Model.MySql.UserValue>(user1Value3);

            var user2Value1 = new Model.MySql.UserValue
            {
                UserId = user2.Id,
                Value = 3.7,
            };

            base.InsertUserValue<Model.MySql.UserValue>(user2Value1);

            var user2Value2 = new Model.MySql.UserValue
            {
                UserId = user2.Id,
                Value = 4.3,
            };

            base.InsertUserValue<Model.MySql.UserValue>(user2Value2);

            var user2Value3 = new Model.MySql.UserValue
            {
                UserId = user2.Id,
                Value = 5.9,
            };

            base.InsertUserValue<Model.MySql.UserValue>(user2Value3);

            var userValues = new List<Model.MySql.UserValue> { user1Value1, user1Value2, user1Value3, user2Value1, user2Value2, user2Value3 };
            ...
            IEnumerable<Model.UserValueAmount> userValueAmounts = sqlContext
                .Select<Model.MySql.UserValue>(x => new { x.UserId },
                    aggregate: a =>
                    {
                        a.Count<Model.MySql.UserValue>(x => x.Value, alias: "Amount");
                    })
                .GroupBy<Model.MySql.UserValue>(x => x.UserId)
        ...
        public void Select_Max()
        {
            ...
            IEnumerable<Model.UserValueAmount> userValueAmounts = sqlContext
                .Select<Model.MySql.UserValue>(x => new { x.UserId },
                    aggregate: a =>
                    {
                        a.Max<Model.MySql.UserValue>(x => x.Value, alias: "Amount");
                    })
                .GroupBy<Model.MySql.UserValue>(x => x.UserId)
                .Query<Model.UserValueAmount>();
        ...
        public void Select_Min()
        {
            ...
            IEnumerable<Model.UserValueAmount> userValueAmounts = sqlContext
                .Select<Model.MySql.UserValue>(x => new { x.UserId },
                    aggregate: a =>
                    {
                        a.Min<Model.MySql.UserValue>(x => x.Value, alias: "Amount");
                    })
                .GroupBy<Model.MySql.UserValue>(x => x.UserId)
                .Query<Model.UserValueAmount>();
        ...
        public void Select_Sum()
        {
            ...
            IEnumerable<Model.UserValueAmount> userValueAmounts = sqlContext
                .Select<Model.MySql.UserValue>(x => new { x.UserId },
                    aggregate: a =>
                    {
                        a.Sum<Model.MySql.UserValue>(x => x.Value, alias: "Amount");
                    })
                .GroupBy<Model.MySql.UserValue>(x => x.UserId)
                .Query<Model.UserValueAmount>();
        ...
        public void Select_Avg()
        {
            ...
            IEnumerable<Model.UserValueAmount> userValueAmounts = sqlContext
                .Select<Model.MySql.UserValue>(x => new { x.UserId },
                    aggregate: a =>
                    {
                        a.Avg<Model.MySql.UserValue>(x => x.Value, alias: "Amount");
                    })
                .GroupBy<Model.MySql.UserValue>(x => x.UserId)
                .Query<Model.UserValueAmount>();
        ...
        public void Insert_In_Transaction()
        {
            ...
            int user1Id = (int)sqlContext
                .Insert<Model.MySql.User>(x => new { x.Nick, x.Password }, user1ToInsert.Nick, user1ToInsert.Password)
                .ExecuteScalar();

            user1ToInsert.Id = user1Id;

            int user2Id = (int)sqlContext
                .Insert<Model.MySql.User>(x => new { x.Nick, x.Password }, user2ToInsert.Nick, user2ToInsert.Password)
                .ExecuteScalar();
            ...
            foreach (var userToInsert in usersToInsert)
            {
                Model.MySql.User user = users.FirstOrDefault(x => x.Id == userToInsert.Id);
        ...
        public void Insert_Update_In_Transaction()
        {
            ...
            int rowNumber = sqlContext
                .Update<Model.MySql.User>(x => new { x.Nick, x.Password }, nickToUpdate, passwordToUpdate)
                .Where<Model.MySql.User>(x => x.Id, Common.Operators.EqualTo, userToInsert.Id)
                .Execute();
        ...
        public void Insert_Update_In_Transaction_2_Same_Connection()
        {
            ...
            int rowNumber1 = sqlContext
                .Update<Model.MySql.User>(x => new { x.Nick, x.Password }, nick1ToUpdate, password1ToUpdate)
                .Where<Model.MySql.User>(x => x.Id, Common.Operators.EqualTo, user1ToInsert.Id)
                .Execute();
            ...
            IEnumerable<Model.MySql.User> usersFirst = base.GetUsers<Model.MySql.User>();
            ...
            int rowNumber2 = sqlContext
                .Update<Model.MySql.User>(x => new { x.Nick, x.Password }, nick2ToUpdate, password2ToUpdate)
                .Where<Model.MySql.User>(x => x.Id, Common.Operators.EqualTo, user2ToInsert.Id)
                .Execute();
            ...
            IEnumerable<Model.MySql.User> usersSecond = base.GetUsers<Model.MySql.User>();
        ...
        public void Transaction_Fails()
        {
            ...
            var exception = Assert.Throws<Exception>(() =>
            {
                ...
                {
                    int userId = (int)sqlContext
                        .Insert<Model.MySql.User>(x => new { x.Nick, x.Password }, user.Nick, user.Password)
                        .ExecuteScalar();

                    int rowNumber = sqlContext
                        .Update<Model.MySql.User>(x => new { x.Nick, x.Password }, nickToUpdate, passwordToUpdate)
                        .Where<Model.MySql.User>(x => x.Id, Common.Operators.EqualTo, -1)
                        .Execute();
        ...
        public void Insert_Sql_Error()
        {
            ...
            try
            {
                int userValueId = (int)sqlContext
                    .Insert<Model.MySql.UserValue>(x => new { x.UserId, x.Value }, userId, value)
                    .ExecuteScalar();
            }
            catch (Exception ex)
            {
        ...
        public void SpInsertUser()
        {
            ...
            int rowNumber = sqlContext
                .StoredProcedure<Model.MySql.SpInsertUser>(x => new { x.Nick, x.Password }, user.Nick, user.Password)
                .Execute();
        ...
        public void SpInsertUserAndGetId()
        {
            ...
            int userId = (int)sqlContext
                .StoredProcedure<Model.MySql.SpInsertUserAndGetId>(x => new { x.Nick, x.Password }, user.Nick, user.Password)
                .ExecuteAndRead<long>();
        ...
        public void SpGetUserById()
        {
            ...
            base.InsertUser<Model.MySql.User>(userToInsert);
            ...
            Model.MySql.User user = sqlContext
                .StoredProcedure<Model.MySql.SpGetUserById>(x => new { x.Id }, userToInsert.Id)
                .ExecuteAndRead<Model.MySql.User>();
        ...
        public async Task SpGetUserById_Async()
        {
            ...
            Model.MySql.User user = await sqlContext
                .StoredProcedure<Model.MySql.SpGetUserById>(x => new { x.Id }, userToInsert.Id)
                .ExecuteAndReadAsync<Model.MySql.User>();
        ...
        public void SpGetUsers()
        {
            ...
            base.InsertUser<Model.MySql.User>(user1ToInsert);
            ...
            base.InsertUser<Model.MySql.User>(user2ToInsert);
            ...
            IEnumerable<Model.MySql.User> users = sqlContext
                .StoredProcedure<Model.MySql.SpGetUsers>()
                .ExecuteAndRead<IEnumerable<Model.MySql.User>>();
        ...
        public async Task SpGetUsers_Async()
        {
            ...
            IEnumerable<Model.MySql.User> users = await sqlContext
                .StoredProcedure<Model.MySql.SpGetUsers>()
                .ExecuteAndReadAsync<IEnumerable<Model.MySql.User>>();
        ...
        public void FnGetUserIdByNick()
        {
            ...
            int userId = sqlContext
                .ScalarFunction<Model.MySql.FnGetUserIdByNick>(x => new { x.Nick }, user2ToInsert.Nick)
        ...
        public void Insert_Dates()
        {
            ...
            int id = (int)sqlContext
                .Insert<Model.MySql.DateAndTime>(x => new
            ...
            Model.MySql.DateAndTime dateAndTime = sqlContext
                .Select<Model.MySql.DateAndTime>(x => new { x.Id, x.DateTime, x.DateOnly })
                .Where<Model.MySql.DateAndTime>(x => x.Id, Common.Operators.EqualTo, id)
                .OrderBy<Model.MySql.DateAndTime>(x => x.Id, Common.Orders.Ascending)
                .LimitOffset(1)
                .QueryFirstOrDefault<Model.MySql.DateAndTime>();
