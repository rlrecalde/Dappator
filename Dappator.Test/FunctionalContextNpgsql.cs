...
{
    public class FunctionalContextNpgsql : See_Firebird_TestBase<Providers.NpgsqlProvider>
    {
        [SetUp]
        public void Setup()
        {
            base._connectionString = "Server=localhost;Port=5432;Database=Dappator;User Id=postgres;Password=guest";
            ...
            var command = new NpgsqlCommand(createDateAndTime, (NpgsqlConnection)dbConnection);
            command.ExecuteNonQuery();
            command.Dispose();

            string deleteDateAndTime = "DELETE FROM dateandtime";

            command = new NpgsqlCommand(deleteDateAndTime, (NpgsqlConnection)dbConnection);
            command.ExecuteNonQuery();
            command.Dispose();
        ...
        public void Insert()
        {
            ...
            var userToInsert = new Model.Npgsql.User
            {
                Nick = "Nick",
                Password = "Password",
            };
            ...
            using var sqlContext = new NpgsqlContext(base._connectionString);

            int userId = (int)sqlContext
                .Insert<Model.Npgsql.User>(x => new { x.Nick, x.Password }, userToInsert.Nick, userToInsert.Password)
                .ExecuteScalar();
            ...
            IEnumerable<Model.Npgsql.User> users = base.GetUsers<Model.Npgsql.User>();
            Assert.That(users.Count(), Is.EqualTo(1));

            Model.Npgsql.User insertedUser = users.First();
        ...
        public void Insert_Bulk()
        {
            ...
            var user1ToInsert = new Model.Npgsql.User
            {
                Nick = "Nick1",
                Password = "Password1",
            };

            var user2ToInsert = new Model.Npgsql.User
            {
                Nick = "Nick2",
                Password = "Password2",
            };

            var usersToInsert = new List<Model.Npgsql.User> { user1ToInsert, user2ToInsert };
            ...
            int oneUserId = (int)sqlContext
                .Insert<Model.Npgsql.User>(x => new { x.Nick, x.Password }, arrayParams)
                .ExecuteScalar();
            ...
            {
                Model.Npgsql.User user = users.FirstOrDefault(x => x.Nick == userToInsert.Nick && x.Password == userToInsert.Password);

                Assert.IsNotNull(user);
                Assert.That(user.Id, Is.GreaterThan(0));
            }

            Assert.IsTrue(users.Any(x => x.Id == oneUserId));
        ...
        public void Update()
        {
            ...
            var user = new Model.Npgsql.User
            {
                Nick = "Nick",
                Password = "Password",
            };

            base.InsertUser<Model.Npgsql.User>(user);
            ...
            int rowNumber = sqlContext
                .Update<Model.Npgsql.User>(x => new { x.Nick, x.Password }, nickToUpdate, passwordToUpdate)
                .Where<Model.Npgsql.User>(x => x.Id, Common.Operators.EqualTo, user.Id)
                .Execute();
            ...
            Model.Npgsql.User updatedUser = users.First();
        ...
        public void Select()
        {
            ...
            var user1 = new Model.Npgsql.User
            {
                Nick = "Nick1",
                Password = "Password1",
            };

            base.InsertUser<Model.Npgsql.User>(user1);

            var user2 = new Model.Npgsql.User
            {
                Nick = "Nick2",
                Password = "Password2",
            };

            base.InsertUser<Model.Npgsql.User>(user2);
            ...
            IEnumerable<Model.Npgsql.User> users = sqlContext
                .Select<Model.Npgsql.User>(x => new { x.Id, x.Nick, x.Password })
                .Query<Model.Npgsql.User>();
        ...
        public async Task Select_Async()
        {
            ...
            IEnumerable<Model.Npgsql.User> users = await sqlContext
                .Select<Model.Npgsql.User>(x => new { x.Id, x.Nick, x.Password })
                .QueryAsync<Model.Npgsql.User>();
        ...
        public void Select_Where()
        {
            ...
            IEnumerable<Model.Npgsql.User> users = sqlContext
                .Select<Model.Npgsql.User>(x => new { x.Id, x.Nick, x.Password })
                .Where<Model.Npgsql.User>(x => x.Id, Common.Operators.EqualTo, user2.Id)
                .Query<Model.Npgsql.User>();
        ...
        public void Select_Limit()
        {
            ...
            IEnumerable<Model.Npgsql.User> users = sqlContext
                .Select<Model.Npgsql.User>(x => new { x.Id, x.Nick, x.Password })
                .OrderBy<Model.Npgsql.User>(x => x.Id, Common.Orders.Ascending)
                .LimitOffset(1)
                .Query<Model.Npgsql.User>();
        ...
        public void Select_Limit_FirstOrDefault()
        {
            ...
            Model.Npgsql.User user = sqlContext
                .Select<Model.Npgsql.User>(x => new { x.Id, x.Nick, x.Password })
                .OrderBy<Model.Npgsql.User>(x => x.Id, Common.Orders.Ascending)
                .LimitOffset(1)
                .QueryFirstOrDefault<Model.Npgsql.User>();
        ...
        public async Task Select_Limit_FirstOrDefault_Async()
        {
            ...
            Model.Npgsql.User user = await sqlContext
                .Select<Model.Npgsql.User>(x => new { x.Id, x.Nick, x.Password })
                .OrderBy<Model.Npgsql.User>(x => x.Id, Common.Orders.Ascending)
                .LimitOffset(1)
                .QueryFirstOrDefaultAsync<Model.Npgsql.User>();
        ...
        public void Select_Count()
        {
            ...
            var user1Value1 = new Model.Npgsql.UserValue
            {
                UserId = user1.Id,
                Value = 1.7,
            };

            base.InsertUserValue<Model.Npgsql.UserValue>(user1Value1);

            var user1Value2 = new Model.Npgsql.UserValue
            {
                UserId = user1.Id,
                Value = 2.3,
            };

            base.InsertUserValue<Model.Npgsql.UserValue>(user1Value2);

            var user1Value3 = new Model.Npgsql.UserValue
            {
                UserId = user1.Id,
                Value = 2.9,
            };

            base.InsertUserValue<Model.Npgsql.UserValue>(user1Value3);

            var user2Value1 = new Model.Npgsql.UserValue
            {
                UserId = user2.Id,
                Value = 3.7,
            };

            base.InsertUserValue<Model.Npgsql.UserValue>(user2Value1);

            var user2Value2 = new Model.Npgsql.UserValue
            {
                UserId = user2.Id,
                Value = 4.3,
            };

            base.InsertUserValue<Model.Npgsql.UserValue>(user2Value2);

            var user2Value3 = new Model.Npgsql.UserValue
            {
                UserId = user2.Id,
                Value = 5.9,
            };

            base.InsertUserValue<Model.Npgsql.UserValue>(user2Value3);

            var userValues = new List<Model.Npgsql.UserValue> { user1Value1, user1Value2, user1Value3, user2Value1, user2Value2, user2Value3 };
            ...
            IEnumerable<Model.UserValueAmount> userValueAmounts = sqlContext
                .Select<Model.Npgsql.UserValue>(x => new { x.UserId },
                    aggregate: a =>
                    {
                        a.Count<Model.Npgsql.UserValue>(x => x.Value, alias: "Amount");
                    })
                .GroupBy<Model.Npgsql.UserValue>(x => x.UserId)
        ...
        public void Select_Max()
        {
            ...
            IEnumerable<Model.UserValueAmount> userValueAmounts = sqlContext
                .Select<Model.Npgsql.UserValue>(x => new { x.UserId },
                    aggregate: a =>
                    {
                        a.Max<Model.Npgsql.UserValue>(x => x.Value, alias: "Amount");
                    })
                .GroupBy<Model.Npgsql.UserValue>(x => x.UserId)
                .Query<Model.UserValueAmount>();
        ...
        public void Select_Min()
        {
            ...
            IEnumerable<Model.UserValueAmount> userValueAmounts = sqlContext
                .Select<Model.Npgsql.UserValue>(x => new { x.UserId },
                    aggregate: a =>
                    {
                        a.Min<Model.Npgsql.UserValue>(x => x.Value, alias: "Amount");
                    })
                .GroupBy<Model.Npgsql.UserValue>(x => x.UserId)
                .Query<Model.UserValueAmount>();
        ...
        public void Select_Sum()
        {
            ...
            IEnumerable<Model.UserValueAmount> userValueAmounts = sqlContext
                .Select<Model.Npgsql.UserValue>(x => new { x.UserId },
                    aggregate: a =>
                    {
                        a.Sum<Model.Npgsql.UserValue>(x => x.Value, alias: "Amount");
                    })
                .GroupBy<Model.Npgsql.UserValue>(x => x.UserId)
                .Query<Model.UserValueAmount>();
        ...
        public void Select_Avg()
        {
            ...
            IEnumerable<Model.UserValueAmount> userValueAmounts = sqlContext
                .Select<Model.Npgsql.UserValue>(x => new { x.UserId },
                    aggregate: a =>
                    {
                        a.Avg<Model.Npgsql.UserValue>(x => x.Value, alias: "Amount");
                    })
                .GroupBy<Model.Npgsql.UserValue>(x => x.UserId)
                .Query<Model.UserValueAmount>();
        ...
        public void Insert_In_Transaction()
        {
            ...
            int user1Id = (int)sqlContext
                .Insert<Model.Npgsql.User>(x => new { x.Nick, x.Password }, user1ToInsert.Nick, user1ToInsert.Password)
                .ExecuteScalar();

            user1ToInsert.Id = user1Id;

            int user2Id = (int)sqlContext
                .Insert<Model.Npgsql.User>(x => new { x.Nick, x.Password }, user2ToInsert.Nick, user2ToInsert.Password)
                .ExecuteScalar();
            ...
            foreach (var userToInsert in usersToInsert)
            {
                Model.Npgsql.User user = users.FirstOrDefault(x => x.Id == userToInsert.Id);
        ...
        public void Insert_Update_In_Transaction()
        {
            ...
            int rowNumber = sqlContext
                .Update<Model.Npgsql.User>(x => new { x.Nick, x.Password }, nickToUpdate, passwordToUpdate)
                .Where<Model.Npgsql.User>(x => x.Id, Common.Operators.EqualTo, userToInsert.Id)
                .Execute();
        ...
        public void Insert_Update_In_Transaction_2_Same_Connection()
        {
            ...
            int rowNumber1 = sqlContext
                .Update<Model.Npgsql.User>(x => new { x.Nick, x.Password }, nick1ToUpdate, password1ToUpdate)
                .Where<Model.Npgsql.User>(x => x.Id, Common.Operators.EqualTo, user1ToInsert.Id)
                .Execute();
            ...
            IEnumerable<Model.Npgsql.User> usersFirst = base.GetUsers<Model.Npgsql.User>();
            ...
            int rowNumber2 = sqlContext
                .Update<Model.Npgsql.User>(x => new { x.Nick, x.Password }, nick2ToUpdate, password2ToUpdate)
                .Where<Model.Npgsql.User>(x => x.Id, Common.Operators.EqualTo, user2ToInsert.Id)
                .Execute();
            ...
            IEnumerable<Model.Npgsql.User> usersSecond = base.GetUsers<Model.Npgsql.User>();
        ...
        public void Transaction_Fails()
        {
            ...
            var exception = Assert.Throws<Exception>(() =>
            {
                ...
                {
                    int userId = (int)sqlContext
                        .Insert<Model.Npgsql.User>(x => new { x.Nick, x.Password }, user.Nick, user.Password)
                        .ExecuteScalar();

                    int rowNumber = sqlContext
                        .Update<Model.Npgsql.User>(x => new { x.Nick, x.Password }, nickToUpdate, passwordToUpdate)
                        .Where<Model.Npgsql.User>(x => x.Id, Common.Operators.EqualTo, -1)
                        .Execute();
        ...
        public void Insert_Sql_Error()
        {
            ...
            try
            {
                int userValueId = (int)sqlContext
                    .Insert<Model.Npgsql.UserValue>(x => new { x.UserId, x.Value }, userId, value)
                    .ExecuteScalar();
            }
            catch (Exception ex)
            {
        ...
        public void SpInsertUser()
        {
            ...
            int rowNumber = sqlContext
                .StoredProcedure<Model.Npgsql.SpInsertUser>(x => new { x.Nick, x.Password }, user.Nick, user.Password)
                .Execute();
            ...
            //Assert.That(rowNumber, Is.EqualTo(1));
            //PostgreSQL stored procedures do not return inserted rows number by default,
        ...
        public async Task SpInsertUser_Async()
        {
            ...
            //PostgreSQL stored procedures do not return inserted rows number by default,
            //but you can change it by making it return in an explicit way and then use
            //the ExecuteAndReadAsync<int>() method instead of ExecuteAsync().
        ...
        public void SpInsertUserAndGetId()
        {
            ...
            int userId = (int)sqlContext
                .StoredProcedure<Model.Npgsql.SpInsertUserAndGetId>(x => new { x.Nick, x.Password }, user.Nick, user.Password)
                .ExecuteAndRead<long>();
        ...
        public void SpGetUserById()
        {
            ...
            base.InsertUser<Model.Npgsql.User>(userToInsert);
            ...
            Model.Npgsql.User user = sqlContext
                .StoredProcedure<Model.Npgsql.SpGetUserById>(x => new { x.Id }, userToInsert.Id)
                .ExecuteAndRead<Model.Npgsql.User>();
        ...
        public async Task SpGetUserById_Async()
        {
            ...
            Model.Npgsql.User user = await sqlContext
                .StoredProcedure<Model.Npgsql.SpGetUserById>(x => new { x.Id }, userToInsert.Id)
                .ExecuteAndReadAsync<Model.Npgsql.User>();
        ...
        {
            // Unlike MSSQL procedures, PostgreSQL procedures can't return a bunch of rows.
        ...
        public void FnGetUsers()
        {
            ...
            base.InsertUser<Model.Npgsql.User>(user1ToInsert);
            ...
            base.InsertUser<Model.Npgsql.User>(user2ToInsert);
            ...
            IEnumerable<Model.Npgsql.User> users = sqlContext
                .TableFunction<Model.Npgsql.FnGetUsers>()
                .ExecuteAndQuery<Model.Npgsql.User>();
        ...
        public async Task FnGetUsers_Async()
        {
            ...
            IEnumerable<Model.Npgsql.User> users = await sqlContext
                .TableFunction<Model.Npgsql.FnGetUsers>()
                .ExecuteAndQueryAsync<Model.Npgsql.User>();
        ...
        public void FnGetUserIdByNick()
        {
            ...
            int userId = sqlContext
                .ScalarFunction<Model.Npgsql.FnGetUserIdByNick>(x => new { x.Nick }, user2ToInsert.Nick)
        ...
        public void Insert_Dates()
        {
            ...
            int id = (int)sqlContext
                .Insert<Model.Npgsql.DateAndTime>(x => new
            ...
            Model.Npgsql.DateAndTime dateAndTime = sqlContext
                .Select<Model.Npgsql.DateAndTime>(x => new { x.Id, x.DateTime, x.DateOnly })
                .Where<Model.Npgsql.DateAndTime>(x => x.Id, Common.Operators.EqualTo, id)
                .OrderBy<Model.Npgsql.DateAndTime>(x => x.Id, Common.Orders.Ascending)
                .LimitOffset(1)
                .QueryFirstOrDefault<Model.Npgsql.DateAndTime>();
