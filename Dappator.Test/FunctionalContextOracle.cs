...
{
    public class FunctionalContextOracle : See_Firebird_TestBase<Providers.OracleProvider>
    {
        [SetUp]
        public void Setup()
        {
            ...
            string createDateAndTime = @"
                CREATE TABLE IF NOT EXISTS DateAndTime (
                    ...
                    DateOnly TIMESTAMP NOT NULL,
                    TimeOnly TIMESTAMP NOT NULL,
                    CONSTRAINT PK_DateAndTime PRIMARY KEY (Id)
                )";

            var command = new OracleCommand(createDateAndTime, (OracleConnection)dbConnection);
            command.ExecuteNonQuery();
            command.Dispose();

            string deleteDateAndTime = "DELETE FROM DateAndTime";

            command = new OracleCommand(deleteDateAndTime, (OracleConnection)dbConnection);
            command.ExecuteNonQuery();
            command.Dispose();
        ...
        public void Insert()
        {
            ...
            var userToInsert = new Model.Oracle.User
            {
                Nick = "Nick",
                Password = "Password",
            };
            ...
            using var sqlContext = new OracleContext(base._connectionString);

            int userId = (int)sqlContext
                .Insert<Model.Oracle.User>(x => new { x.Nick, x.Password }, userToInsert.Nick, userToInsert.Password)
                .ExecuteScalar();
            ...
            IEnumerable<Model.Oracle.User> users = base.GetUsers<Model.Oracle.User>();
            Assert.That(users.Count(), Is.EqualTo(1));

            Model.Oracle.User insertedUser = users.First();
        ...
        public void Insert_Bulk()
        {
            ...
            var user1ToInsert = new Model.Oracle.User
            {
                Nick = "Nick1",
                Password = "Password1",
            };

            var user2ToInsert = new Model.Oracle.User
            {
                Nick = "Nick2",
                Password = "Password2",
            };

            var usersToInsert = new List<Model.Oracle.User> { user1ToInsert, user2ToInsert };
            ...
            int oneUserId = (int)sqlContext
                .Insert<Model.Oracle.User>(x => new { x.Nick, x.Password }, arrayParams)
                .ExecuteScalar();
            ...
            {
                Model.Oracle.User user = users.FirstOrDefault(x => x.Nick == userToInsert.Nick && x.Password == userToInsert.Password);
        ...
        public void Update()
        {
            ...
            var user = new Model.Oracle.User
            {
                Nick = "Nick",
                Password = "Password",
            };

            base.InsertUser<Model.Oracle.User>(user);
            ...
            int rowNumber = sqlContext
                .Update<Model.Oracle.User>(x => new { x.Nick, x.Password }, nickToUpdate, passwordToUpdate)
                .Where<Model.Oracle.User>(x => x.Id, Common.Operators.EqualTo, user.Id)
                .Execute();
            ...
            Model.Oracle.User updatedUser = users.First();
        ...
        public void Select()
        {
            ...
            var user1 = new Model.Oracle.User
            {
                Nick = "Nick1",
                Password = "Password1",
            };

            base.InsertUser<Model.Oracle.User>(user1);

            var user2 = new Model.Oracle.User
            {
                Nick = "Nick2",
                Password = "Password2",
            };

            base.InsertUser<Model.Oracle.User>(user2);
            ...
            IEnumerable<Model.Oracle.User> users = sqlContext
                .Select<Model.Oracle.User>(x => new { x.Id, x.Nick, x.Password })
                .Query<Model.Oracle.User>();
        ...
        public async Task Select_Async()
        {
            ...
            IEnumerable<Model.Oracle.User> users = await sqlContext
                .Select<Model.Oracle.User>(x => new { x.Id, x.Nick, x.Password })
                .QueryAsync<Model.Oracle.User>();
        ...
        public void Select_Where()
        {
            ...
            IEnumerable<Model.Oracle.User> users = sqlContext
                .Select<Model.Oracle.User>(x => new { x.Id, x.Nick, x.Password })
                .Where<Model.Oracle.User>(x => x.Id, Common.Operators.EqualTo, user2.Id)
                .Query<Model.Oracle.User>();
        ...
        public void Select_Limit()
        {
            ...
            IEnumerable<Model.Oracle.User> users = sqlContext
                .Select<Model.Oracle.User>(x => new { x.Id, x.Nick, x.Password })
                .OrderBy<Model.Oracle.User>(x => x.Id, Common.Orders.Ascending)
                .LimitOffset(1)
                .Query<Model.Oracle.User>();
        ...
        public void Select_Limit_FirstOrDefault()
        {
            ...
            Model.Oracle.User user = sqlContext
                .Select<Model.Oracle.User>(x => new { x.Id, x.Nick, x.Password })
                .OrderBy<Model.Oracle.User>(x => x.Id, Common.Orders.Ascending)
                .LimitOffset(1)
                .QueryFirstOrDefault<Model.Oracle.User>();
        ...
        public async Task Select_Limit_FirstOrDefault_Async()
        {
            ...
            Model.Oracle.User user = await sqlContext
                .Select<Model.Oracle.User>(x => new { x.Id, x.Nick, x.Password })
                .OrderBy<Model.Oracle.User>(x => x.Id, Common.Orders.Ascending)
                .LimitOffset(1)
                .QueryFirstOrDefaultAsync<Model.Oracle.User>();
        ...
        public void Select_Count()
        {
            ...
            var user1Value1 = new Model.Oracle.UserValue
            {
                UserId = user1.Id,
                Value = 1.7,
            };

            base.InsertUserValue<Model.Oracle.UserValue>(user1Value1);

            var user1Value2 = new Model.Oracle.UserValue
            {
                UserId = user1.Id,
                Value = 2.3,
            };

            base.InsertUserValue<Model.Oracle.UserValue>(user1Value2);

            var user1Value3 = new Model.Oracle.UserValue
            {
                UserId = user1.Id,
                Value = 2.9,
            };

            base.InsertUserValue<Model.Oracle.UserValue>(user1Value3);

            var user2Value1 = new Model.Oracle.UserValue
            {
                UserId = user2.Id,
                Value = 3.7,
            };

            base.InsertUserValue<Model.Oracle.UserValue>(user2Value1);

            var user2Value2 = new Model.Oracle.UserValue
            {
                UserId = user2.Id,
                Value = 4.3,
            };

            base.InsertUserValue<Model.Oracle.UserValue>(user2Value2);

            var user2Value3 = new Model.Oracle.UserValue
            {
                UserId = user2.Id,
                Value = 5.9,
            };

            base.InsertUserValue<Model.Oracle.UserValue>(user2Value3);

            var userValues = new List<Model.Oracle.UserValue> { user1Value1, user1Value2, user1Value3, user2Value1, user2Value2, user2Value3 };
            ...
            IEnumerable<Model.UserValueAmount> userValueAmounts = sqlContext
                .Select<Model.Oracle.UserValue>(x => new { x.UserId },
                    aggregate: a =>
                    {
                        a.Count<Model.Oracle.UserValue>(x => x.Value, alias: "Amount");
                    })
                .GroupBy<Model.Oracle.UserValue>(x => x.UserId)
        ...
        public void Select_Max()
        {
            ...
            IEnumerable<Model.UserValueAmount> userValueAmounts = sqlContext
                .Select<Model.Oracle.UserValue>(x => new { x.UserId },
                    aggregate: a =>
                    {
                        a.Max<Model.Oracle.UserValue>(x => x.Value, alias: "Amount");
                    })
                .GroupBy<Model.Oracle.UserValue>(x => x.UserId)
                .Query<Model.UserValueAmount>();
        ...
        public void Select_Min()
        {
            ...
            IEnumerable<Model.UserValueAmount> userValueAmounts = sqlContext
                .Select<Model.Oracle.UserValue>(x => new { x.UserId },
                    aggregate: a =>
                    {
                        a.Min<Model.Oracle.UserValue>(x => x.Value, alias: "Amount");
                    })
                .GroupBy<Model.Oracle.UserValue>(x => x.UserId)
                .Query<Model.UserValueAmount>();
        ...
        public void Select_Sum()
        {
            ...
            IEnumerable<Model.UserValueAmount> userValueAmounts = sqlContext
                .Select<Model.Oracle.UserValue>(x => new { x.UserId },
                    aggregate: a =>
                    {
                        a.Sum<Model.Oracle.UserValue>(x => x.Value, alias: "Amount");
                    })
                .GroupBy<Model.Oracle.UserValue>(x => x.UserId)
                .Query<Model.UserValueAmount>();
        ...
        public void Select_Avg()
        {
            ...
            IEnumerable<Model.UserValueAmount> userValueAmounts = sqlContext
                .Select<Model.Oracle.UserValue>(x => new { x.UserId },
                    aggregate: a =>
                    {
                        a.Avg<Model.Oracle.UserValue>(x => x.Value, cast: "decimal(10, 5)", alias: "Amount");
                    })
                .GroupBy<Model.Oracle.UserValue>(x => x.UserId)
                .Query<Model.UserValueAmount>();
        ...
        public void Insert_In_Transaction()
        {
            ...
            int user1Id = (int)sqlContext
                .Insert<Model.Oracle.User>(x => new { x.Nick, x.Password }, user1ToInsert.Nick, user1ToInsert.Password)
                .ExecuteScalar();

            user1ToInsert.Id = user1Id;

            int user2Id = (int)sqlContext
                .Insert<Model.Oracle.User>(x => new { x.Nick, x.Password }, user2ToInsert.Nick, user2ToInsert.Password)
                .ExecuteScalar();
            ...
            foreach (var userToInsert in usersToInsert)
            {
                Model.Oracle.User user = users.FirstOrDefault(x => x.Id == userToInsert.Id);
        ...
        public void Insert_Update_In_Transaction()
        {
            ...
            int rowNumber = sqlContext
                .Update<Model.Oracle.User>(x => new { x.Nick, x.Password }, nickToUpdate, passwordToUpdate)
                .Where<Model.Oracle.User>(x => x.Id, Common.Operators.EqualTo, userToInsert.Id)
                .Execute();
        ...
        public void Insert_Update_In_Transaction_2_Same_Connection()
        {
            ...
            int rowNumber1 = sqlContext
                .Update<Model.Oracle.User>(x => new { x.Nick, x.Password }, nick1ToUpdate, password1ToUpdate)
                .Where<Model.Oracle.User>(x => x.Id, Common.Operators.EqualTo, user1ToInsert.Id)
                .Execute();
            ...
            IEnumerable<Model.Oracle.User> usersFirst = base.GetUsers<Model.Oracle.User>();
            ...
            int rowNumber2 = sqlContext
                .Update<Model.Oracle.User>(x => new { x.Nick, x.Password }, nick2ToUpdate, password2ToUpdate)
                .Where<Model.Oracle.User>(x => x.Id, Common.Operators.EqualTo, user2ToInsert.Id)
                .Execute();
            ...
            IEnumerable<Model.Oracle.User> usersSecond = base.GetUsers<Model.Oracle.User>();
        ...
        public void Transaction_Fails()
        {
            ...
            var exception = Assert.Throws<Exception>(() =>
            {
                ...
                {
                    int userId = (int)sqlContext
                        .Insert<Model.Oracle.User>(x => new { x.Nick, x.Password }, user.Nick, user.Password)
                        .ExecuteScalar();

                    int rowNumber = sqlContext
                        .Update<Model.Oracle.User>(x => new { x.Nick, x.Password }, nickToUpdate, passwordToUpdate)
                        .Where<Model.Oracle.User>(x => x.Id, Common.Operators.EqualTo, -1)
                        .Execute();
        ...
        public void Insert_Sql_Error()
        {
            ...
            try
            {
                int userValueId = (int)sqlContext
                    .Insert<Model.Oracle.UserValue>(x => new { x.UserId, x.Value }, userId, value)
                    .ExecuteScalar();
            }
            catch (Exception ex)
            {
        ...
        public void SpInsertUser()
        {
            ...
            int rowNumber = sqlContext
                .StoredProcedure<Model.Oracle.SpInsertUser>(x => new { x.Nick, x.Password }, user.Nick, user.Password)
                .Execute();
        ...
        public void FnGetUsers()
        {
            ...
            base.InsertUser<Model.Oracle.User>(user1ToInsert);
            ...
            base.InsertUser<Model.Oracle.User>(user2ToInsert);
            ...
            IEnumerable<Model.Oracle.User> users = sqlContext
                .TableFunction<Model.Oracle.FnGetUsers>()
                .ExecuteAndQuery<Model.Oracle.User>();
        ...
        public async Task FnGetUsers_Async()
        {
            ...
            IEnumerable<Model.Oracle.User> users = await sqlContext
                .TableFunction<Model.Oracle.FnGetUsers>()
                .ExecuteAndQueryAsync<Model.Oracle.User>();
        ...
        public void FnGetUserIdByNick()
        {
            ...
            int userId = sqlContext
                .ScalarFunction<Model.Oracle.FnGetUserIdByNick>(x => new { x.Nick }, user2ToInsert.Nick)
        ...
        public void Insert_Dates()
        {
            ...
            int id = (int)sqlContext
                .Insert<Model.Oracle.DateAndTime>(x => new
            ...
            Model.Oracle.DateAndTime dateAndTime = sqlContext
                .Select<Model.Oracle.DateAndTime>(x => new { x.Id, x.DateTime, x.DateOnly })
                .Where<Model.Oracle.DateAndTime>(x => x.Id, Common.Operators.EqualTo, id)
                .OrderBy<Model.Oracle.DateAndTime>(x => x.Id, Common.Orders.Ascending)
                .LimitOffset(1)
                .QueryFirstOrDefault<Model.Oracle.DateAndTime>();
