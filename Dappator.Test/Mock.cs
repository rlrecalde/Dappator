...
namespace Dappator.Test
{
    public class Mock
    {
        ...
        private Mock<Interfaces.IQueryBuilderExecuteScalar> _queryBuilderExecuteScalarMock;
        ...
        public void Setup()
        {
            ...
            // For Insert()
            this._queryBuilderExecuteScalarMock = new Mock<Interfaces.IQueryBuilderExecuteScalar>();
        ...
        public async Task Insert()
        {
            ...
            this._queryBuilderExecuteScalarMock.Setup(x => x.ExecuteScalarAsync())
            ...
            this._customContextMock.Setup(x => x.Insert<AnyClass>(It.IsAny<Expression<Func<AnyClass, dynamic>>>(), It.IsAny<object[]>()))
                                   .Returns(this._queryBuilderExecuteScalarMock.Object);
        ...
        public async Task Update()
        {
            ...
            this._queryBuilderWhereMock.Setup(x => x.Where<AnyClass>(It.IsAny<Expression<Func<AnyClass, object>>>(), It.IsAny<Common.Operators>(), It.IsAny<object>(), It.IsAny<object>(), It.IsAny<string>()))
        ...
        public async Task Delete()
        {
            ...
            this._firstQueryBuilderAndOrMock.Setup(x => x.And<AnyClass>(It.IsAny<Expression<Func<AnyClass, object>>>(), It.IsAny<Common.Operators>(), It.IsAny<object>(), It.IsAny<object>(), It.IsAny<bool>(), It.IsAny<bool>(), It.IsAny<string>()))
    ...
    public class CustomContext : SqliteContext, ICustomContext
    {
        public CustomContext(string connectionString, bool preventClosing = false) : base(connectionString, preventClosing)
        {
        }
    }
}
